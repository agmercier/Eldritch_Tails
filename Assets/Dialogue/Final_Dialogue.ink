...
He carefully gets off the bed and looks out the window, into the dark forest. It should be around sunrise, but because {NPC_Name} and his family live on the outskirts of the village, right next to the forest, it is always dark. #background: house blank
...
===requestforwood===
Plower: "Now, don't look so disappointing. I tried to save what I could, otherwise we would have nothing." #background: veggie field 1.1 #right: plower #left: NPC
...
In the old days, the village had had a well as well for their water supply, but it has long since fallen to ruins and for now, the village is dependent on the muddy creeks for their water supply. However, recently the villagers started on the project to rebuild the old thing. It is tedious work, but it finally seems like it's getting closer to completion. #background: veggie field 1.1
Plower: "Speaking of it, I heard you want to leave the village", he continues. A hint of displeasure leaks through his casual demeanor. #background: veggie field 1.1 #right: plower #left: NPC
+ [Nod] ->nod1

===nod1===
{NPC_Name} nods. #background: veggie field 1.1 #left: NPC #right: plower
...
===question1===
Plower: "Oh, by the way, could I ask a job of you? My crates for storing vegetables are getting weary and old. Can you get me some fresh wood to repair them?" #background: veggie field 1.1 #left: NPC #right: plower
...
What is going on?! 
He screams for help, trying to pull his arm away from his own grip. Sinking further into the ground, until his mouth starts filling with earth and his yells are muffled. Before long, his eyes were submerged as well and he was completely dragged into the ground. #background: veggie field 2.1 
->END

===decline1===
{NPC_Name}: "I'm sorry, I have other engagements." #background: veggie field 1.1 #left: NPC #right: plower
...
+ {accept1 || accept2} [Get wood] ->getwood1
...
+ {not getwood1} {accept1 || accept2} [Get wood] ->getwood1
+ [Go back home] ->supplies1
...
As one of the hunters leans on {NPC_Name}'s cart to take a breather, he nearly falls to the ground as the wooden handlebar snaps of and breaks. Well, for now {NPC_Name} has his job to do. It seems he'll be gathering wood not only for the plower but for himself aswell. He walks away into the forest to get some wood. #background: veggie field 1.1 #left: NPC #right: hunter 2
